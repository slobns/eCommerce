...
if($category == ''){
    $errors[] .= "Popunite polje kategorije. Ne moze ostati prazno.";
}
// if exist in database
if($count > 0){
   $errors[] .= $category.' se vec nalazi u bazi.' ;
}
//Display Errors and update datebase
if(!empty($errors)){
    //display errors
...
<?php }else{
    //update datebase
    $updatesql = "INSERT INTO categories (category, parent) VALUE ('$category', '$post_parent')";
    if(isset($_GET['edit'])){
...
<div class="row">
    ...
    <div class="col-md-6">
        <form class="form" action="categories.php<?=((isset($_GET['edit'])))?'?edit='.$edit_id:'';?>" method="post">
            ...
            <div class="form-group">
                <input type="submit" value="<?=((isset($_GET['edit']))?'Izmeni':'Dodaj');?>" class="btn btn-success">
            </div>
        </form>
    </div>
    <div class="col-md-6">
